...
//         <ul className="header_links" style="Display:Flex; justify-content: space-between; align-items: center">
...
//         </ul>
//     </nav>
// <img src="images/stand-in.JPG" alt=""></img>
//     <div className="mid" style="Display:Flex; justify-content: space-between; flex-wrap:wrap; padding: 2rem">
//         <div className="mid_item">
//             <span className="mid_item_image">&lt;</span>
//             <span>3-3 1/2 hours</span>
//         </div>
//         <div className="mid_item">
//             <span className="mid_item_image">&lt;</span>
//             <span>6 stops</span>
...
//         <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis quaerat maiores voluptatum perspiciatis repudiandae iure modi asperiores natus ipsam recusandae pariatur nemo tempore, expedita reiciendis voluptatibus error ipsum. Libero, officiis.</p>
//         <ul>
//             <li>first, you'll go here</li>
//             <br></br>
//             <br></br>
//             <li>first, you'll go here</li>
//             <br></br>
...
//     </main>
//     <div className="what" style="width: 20%; display: flex; justify-content:space-around">
//         <div className="what__food">
//         <h2>The Food</h2>
//         <li>lorem</li>
//         <li>lorem</li>
//         <li>lorem</li>
...
//         </div>
//     </div>
//     <div className = "why" style="width: 10%">
//         <p>WHY SHOREDITCH?
