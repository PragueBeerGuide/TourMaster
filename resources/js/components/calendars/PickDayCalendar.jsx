...
export default function PickDayCalendar() {
    return (
        <>
            <div className="flex items-center justify-center">
                <div className="2xl:w-1/3 xl:w-1/2 lg:w-3/5 sm:w-4/5 w-full shadow-lg">
                    <div className="md:p-16 md:pb-12 p-4 dark:bg-gray-800 bg-white rounded-t">
                        ...
                        <div className="flex items-center justify-between p-5 overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="pt-6">
                                            <div className="px-4 py-4 cursor-pointer flex w-full justify-center hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300">
                    ...
                    <div className="md:py-5 py-4 md:px-16 px-5 dark:bg-gray-700 bg-gray-50">
                        <div className="px-8">
                            ...
                            <div className="border-b pb-2 border-gray-400 border-dashed pt-5">
