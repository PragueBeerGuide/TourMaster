...
@viteReactRefresh
@vite('resources/js/src/main-too.jsx')

<div class="relative mt-2 flex flex-col items-center rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
    ...
    <h3 class="block font-sans text-2xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">Login</h3>
